...
export default function Home() {
  const [walletAddress, setWalletAddress]: any = useState("UQBQ_yvf5_kjpWh14-HnASNfgVHB33LKoMOzNHcnlQSogIIw");

  const [collectionName, setCollectionName] = useState<string>("J106ER");
  const [collectionDescription, setCollectionDescription] = useState<string>("10,621 Unique Generative Art J6ER tokens to celebrate the debut of JAN6 Coin on the Sol platform. Follow @Jan6Coin on X. Go to jan6coin.com.");
  const [collectionExternalUrl, setCollectionExternalUrl] = useState<string>("https://jan6coin.com");
